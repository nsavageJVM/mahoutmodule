 ...
 * Over time we will use it to embed bias which can then be teased out, 
 * i.e. by clutstering/classifiers. For example:
 * 
...
public class TransactionIteratorFactory {
    ...
    public static enum STATE {
        ...
        AZ(.1f, "dog-food_10","cat-food_8","leather-collar_25","snake-bite ointment_30","turtle-food_11"),
        AK(.1f, "dog-food_10","cat-food_8","fuzzy-collar_19","antelope-caller_20","salmon-bait_30"),
        CT(.1f, "dog-food_10","cat-food_8","fuzzy-collar_19","turtle-pellets_5"),
        OK(.1f, "dog-food_10","cat-food_8","duck-caller_13","rodent-cage_40","hay-bail_5","cow-dung_2"),
        CO(.1f, "dog-food_10","cat-food_8","choke-collar_15","antelope snacks_30","duck-caller_18"    ),
        CA(.3f, "dog-food_10","cat-food_8","fish-food_12","organic-dog-food_16","turtle-pellets_5"    ),
        NY(.2f, "dog-food_10","cat-food_8","steel-leash_20","fish-food_20","seal-spray_25"    );
	...
	public TransactionIteratorFactory(final int records, final STATE state) {
	    ...
	    this.dataIterator = new Iterator<KeyVal<String, String>>(){
            ...
            public KeyVal<String, String> next() {
                /**
                 * Some customers come back for more :)
                 * We repeat a name up to ten times.
                 */
                if(repeat>0)
                    repeat--;
                else{
               ...
               // product_price is product (name, price) ie product_price.getFirst() is name
                String key, val;
                    ...
                    val = join(",",
                               ...
                               lname,
                               getDate().toString(),
                               fudgePrice(product_price.getFirst(), product_price.getSecond()) + "",
                               product_price.getFirst()) ; //products are biased by state
