...
public class MahoutRecommenderTest {
    ...
    final static Logger log= LoggerFactory.getLogger(MahoutRecommenderTest.class);
    ...
    // this code demonstrates how to use filter for hashing and retrieving data from hash
    @Test
    public void setUpPreferenceData() throws Exception {
        ...
        FileReader fileReader = new FileReader(new File("./petstoredata/part-r-00000"));
